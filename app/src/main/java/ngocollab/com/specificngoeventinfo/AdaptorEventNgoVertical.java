...
public class AdaptorEventNgoVertical extends RecyclerView.Adapter<AdaptorEventNgoVertical.MyViewHolder> {
    ...
    public AdaptorEventNgoVertical(List<String> verticalList_name_of_event , List<String> verticalList_day_date , List<String> verticalList_time ,List<String> verticalList_address )
    {
    ...
    @Override
    public AdaptorEventNgoVertical.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
    ...
    @Override
    public void onBindViewHolder(final AdaptorEventNgoVertical.MyViewHolder holder, final int position) {
